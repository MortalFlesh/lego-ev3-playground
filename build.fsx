...
// ========================================================================================================
// === F# / Console Application fake build =================================================== 2019-11-21 =
// --------------------------------------------------------------------------------------------------------
// Options:
...
let project = "Lego - Tests"
let summary = "Test app for lego Mindstorms (EV3)"
...
Target.create "Release" (fun _ ->
    ...
    |> List.iter (fun runtimeId ->
        sprintf "publish -c Release /p:PublishSingleFile=true -o ./dist/%s --self-contained -r %s tests.fsproj" runtimeId runtimeId
